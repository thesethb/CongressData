...
while demyear[n+1]>2001:
     j=-1
     n=n+1
     while j+1<len(membersnames) and demyear[n]==2004:
         j=j+1
         ...
         if (firstfour in demname and demstate[n]==membersstate[j] and demdistrict[n]==membersdistrict[j])or(firstfour in demname and demstate[n]==membersstate[j] and 0 ==demdistrict[n] ):
            ...
            m=n-200
            while(repyear[m+1]>2003):
                m=m+1

                if(repyear[m]==2004 and demstate[n]==repstate[m] and demdistrict[n]==repdistrict[m] and repcandvotes[m]>10000):
...
while repyear[n+1]>2001:
     j=-1
     n=n+1
     while j+1<len(membersnames) and repyear[n]==2004:
         j=j+1
         name=membersnames[j].lower()
         firstfour=name[0:4]
         ...
         if (firstfour in repname and repstate[n]==membersstate[j] and repdistrict[n]==membersdistrict[j] )or(firstfour in repname and repstate[n]==membersstate[j] and repdistrict[n]==0 ) :
            m=n-200
            while(demyear[m+1]>2003):
                m=m+1
                if(demyear[m+1]>=2004 and repstate[n]==demstate[m] and repdistrict[n]==demdistrict[m] and demcandvotes[m]>10000):
